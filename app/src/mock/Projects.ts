...
export const MOCK_PROJECTS = [
    new Project({id: 1,
        ...
        imageUrl: '/assets/sergio-mena-ferreira-N5sC8zZUgy4-unsplash.jpg',
        contractTypeId: 3,
      ...
      new Project({
        ...
        imageUrl: '/assets/meritt-thomas-OGTEP0LyYNk-unsplash.jpg',
        contractTypeId: 4,
      ...
      new Project({
        ...
        imageUrl: '/assets/meritt-thomas-2UsNF4Az-Ko-unsplash.jpg',
        contractTypeId: 6,
      ...
      new Project({
        ...
        imageUrl: '/assets/christina-winter-A8UaAWsFzRM-unsplash.jpg',
        contractTypeId: 4,
      ...
      new Project({
        ...
        imageUrl: '/assets/ben-o-bro-wpU4veNGnHg-unsplash.jpg',
        contractTypeId: 2,
      ...
      new Project({
        ...
        imageUrl: '/assets/sen-lee-EsP2miovnzs-unsplash.jpg',
        contractTypeId: 3,
